        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/todos/**").authenticated() // 🔒 Kräver autentisering för
                                                                                       // POST /todos/**
                        .requestMatchers(HttpMethod.PUT, "/todos/**").authenticated() // 🔒 Kräver autentisering för PUT
                                                                                      // /todos/**
                        .requestMatchers(HttpMethod.DELETE, "/todos/**").authenticated() // 🔒 Kräver autentisering för
                                                                                         // DELETE /todos/**
